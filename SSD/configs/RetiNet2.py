...
from ssd.modeling import SSD300, SSDMultiboxLoss, SSDMultiboxLoss2, backbones, AnchorBoxes
...
anchors = L(AnchorBoxes)(
    ...
    min_sizes=[[19, 20], [17, 41], [25, 67], [46, 56], [92, 115], [128, 220], [127, 397]],
    # [[16, 16], [32, 32], [48, 48], [64, 64], [86, 86], [128, 128], [128, 400]]
    #task 2.4.1 [[19, 20], [17, 41], [25, 67], [46, 56], [92, 115], [128, 220], [127, 397]] 0.08346
    #task 2.4.2 [[15, 40], [24, 31], [15, 55], [18, 56], [54, 85], [126, 215], [128, 284]] 0.04147
...
backbone = L(backbones.FPNResNets2)(
    output_channels=[128, 256, 128, 128, 64, 64],
    image_channels="${train.image_channels}",
    output_feature_sizes="${anchors.feature_sizes}"
)

loss_objective = L(SSDMultiboxLoss2)(anchors="${anchors}")
